...
import {StatusBar,StyleSheet,View,Text,Image, ScrollView,Dimensions,AsyncStorage,TouchableOpacity} from 'react-native';
                ...
                <ScrollView>
                    ...
                    <View style={{marginBottom:10*s,backgroundColor:'#fff'}}>
                        <View style={styles.list_title}>
                            <Icon name="smile" size={22} style={styles.list_icon}/>
                        ...
                        <View style={styles.list}>
                            {
                                myMsg.map((item)=>(
                                    <View style={styles.content}>
                                        <Icon name={item.pic} size={22} style={styles.list_icon} />
                    ...
                    <View style={{marginBottom:10*s,backgroundColor:'#fff'}}>
                        <View style={styles.list_title}>
                            <Icon name="tag" size={22} style={styles.list_icon}/>
                        ...
                        <View style={styles.list}>
                            ...
                            <Button onPress={()=>{Actions.release()}}>
                                <View style={styles.content}>
                                    <Icon name="form" size={22} style={styles.list_icon} />
                                    <Text style={styles.list_text}>我的发布</Text>
                                </View>
                            </Button>
                        </View>
                    </View>
                    <View style={{alignItems:'center',flexDirection:'row',justifyContent:'center',padding:20*s}}>
                        <Text style={{color:'#aaa'}}>BINNU DHILLON | </Text>
                        <TouchableOpacity onPress={()=>{
                            ...
                            .then(res=>{
                                ...
                                <Text style={{color:'#aaa'}}>退出登录</Text>    
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
